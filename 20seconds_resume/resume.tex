...
\profilepic{guido2.jpg} %path of profile pic
\cvname{Guido Avvisati} %your name
\cvjobtitle{Scientific Programmer and\newline Data Scientist}%your actual job position
\cvdate{28 October 1987}%date of birth
\cvaddress{Utrecht, The Netherlands}%address
\cvnumberphone{+31 681 90 39 38}%telphone number
\cvmail{guido.avvisati~[at]~gmail.com}%e-mail
\cvsite{\url{linkedin.com/in/guido-avvisati-6576a7120/}}%personal site
